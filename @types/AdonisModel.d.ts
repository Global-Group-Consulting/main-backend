...
export class AdonisModel extends LucidMongo {
  ...
  static find<T extends AdonisModel> (this: Constructor<T>, id: string | number): Promise<T | null>
  
  static first<T extends AdonisModel> (this: Constructor<T>): Promise<T | null>
