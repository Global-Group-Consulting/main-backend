...
const aggregation = require('./queries/getUsersWithWrongRecapitalization_brites')
...
async function run () {
  try {
    ...
    const coll = await client.db('global_club').collection('movements')
